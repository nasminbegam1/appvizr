            ...
            <div class="portlet-body">
                ...
                <?= DetailView::widget([
                    ...
                    'attributes' => [
                        ...
                        ['attribute'=>'Image',
                            'value'=>Yii::$app->urlManagerFrontend->baseUrl.'/uploads/consultant/thumb/'.$model->profile_image,
                            'format' => ['image'],
                        ],
                        [
                            'attribute'=>'cat_id',
                        ...
                        [
                            ...
                            'value' => $model->sub_cat_name->subcat_name
                        ],
                        [
                            'attribute'=>'qualification_id',
                            'value' => $model->qualification->title
                        ],
                        'description:ntext',
                        'status',
                        'registration_type',
