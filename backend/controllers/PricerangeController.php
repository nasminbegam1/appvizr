...
use app\models\PricerangeSearch;
 ...
 */
class PricerangeController extends BaseController
{
    /**
     * @inheritdoc
     */
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            Yii::$app->session->setFlash('success', 'Price range added successfully');
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            Yii::$app->session->setFlash('success', 'Price range updated successfully');
            return $this->redirect(['index']);
        } else {
