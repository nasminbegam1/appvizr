<table border="0" cellpadding="2" cellspacing="0">
    ...
    <tr><td>------------------------------------------------</td></tr>
    <tr>
        <td>Please click this link to active your account: <a href="<?= Yii::$app->urlManagerFront->baseUrl.'/consultant/activate?key='.$model['auth_key']; ?>"><?= Yii::$app->urlManagerFront->baseUrl.'/consultant/activate?key='.$model['auth_key']; ?></a></td>
    </tr>
</table>